    ...
    <div className="bg-white dark:bg-gray-800 p-4 rounded shadow">
      ...
      <div className="flex flex-wrap items-center">
        {favorite.tags && favorite.tags.map(tag => (
          <div key={tag.id} className="flex items-center bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-1 rounded mr-2 mb-2 text-sm">
            <button
        ...
        {isAddingTag ? (
          ...
          <button
            ...
            className="bg-blue-500 text-white px-2 py-1 rounded mr-2 mb-2 text-sm hover:bg-blue-600 transition-colors duration-200 flex items-center"
          >
